...
@Component
@Slf4j(topic = "SendAppMessageRemindCouponTemplate")
public class SendAppMessageRemindCouponTemplate implements RemindCouponTemplate {
    ...
    public boolean remind(CouponTemplateRemindDTO couponTemplateRemindDTO) {
        // 空实现
        log.info("【应用 App 弹框方式】提醒[用户-{}]抢购【优惠券-{}】", couponTemplateRemindDTO.getUserId(), couponTemplateRemindDTO.getCouponTemplateId());
        return true;
    }
}
